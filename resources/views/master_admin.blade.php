...
<body>
<div id="fb-root"></div>
<script async defer crossorigin="anonymous" src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v7.0" nonce="83fPYtfQ"></script>
    ...
    <ul class="nav pull-right top-menu">
        ...
        <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                <img alt="" src="source/admin/images/2.png">
                <span class="username">Admin</span>
                <b class="caret"></b>
            </a>
            <ul class="dropdown-menu extended logout">
                <li><a onclick="return confirm('Bạn muốn đăng xuất admin?')" href="{{route('admin_logout')}}"><i class="fa fa-key"></i> Log Out</a></li>
            </ul>
        </li>
...
<!--[if lte IE 8]><script language="javascript" type="text/javascript" src="source/admin/js/flot-chart/excanvas.min.js"></script><![endif]-->
...
<!-- calendar -->
	<script type="text/javascript" src="source/admin/js/monthly.js"></script>

...
<div class="test3">
    <h1 class="heading"> Tìm kiếm <span>'{{request()->get("searchbox")}}'</span> </h1>
...
<input type="text" value='' id="searchbox" name="searchbox" hidden="">
...
<script type="text/javascript">
  document.getElementById('searchbox').value = "<?php echo $_GET['searchbox'];?>";
</script>
